...
public class LancamentoController {
	...
	/**
	 * Retorna a listagem de lançamentos de un funcionario
	 * 
	 * @param funcionarioId
	 * @param pag
	 * @param ord
	 ...
	 */
	@GetMapping(value = "{id}")
	public ResponseEntity<Response<LancamentoDto>> lancamentoPorid(
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto,
		...
		if(result.hasErrors()) {
			log.error("Error validando o lançamento {}", result.getAllErrors());
	...
	/**
	 * Converte um LanccamentoDto para lancamento
	 * 
	 * @param lancamentoDto
	 * @param result
	 * @return Lancamento
