...
public class FuncionarioController {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Response<FuncionarioDto>> buscarPorCnpj(@PathVariable("id") Long id,
			@Valid @RequestBody FuncionarioDto funcionarioDto, BindingResult result) throws NoSuchAlgorithmException {
		log.info("Atualizando o funcionário do ID: {}{}", id, funcionarioDto.toString());
	...
	/**
	 * Atualiza dos dados dos funcionário com base nos dados encontrados no DTO.
	 * 
	 * @param funcionario
