...
private static final Logger log = LoggerFactory.getLogger(CadastroPFController.class);
	...
	/**
	 * Verifica se aempresa está cadastrada e se ofuncionário não existe na base de dados
	 * 
	 * @param cadastroPFDto
	 * @param result
	 */
	 ...
	 * @return Empresa
	 */
	private Empresa convertDtoParaEmpresa(CadastroPJDto cadastroPJDto) {
	...
	/**
	 * Convert os dados do DTO para funcionario
	 * @param cadastroPFDto
	 * @param result
	 * @return Funcionario
	 * @throws NoSuchAlgorithmException
	...
	private Funcionario converterDtoParaFuncionario(CadastroPFDto cadastroPFDto, BindingResult result)
		...
		cadastroPFDto.getQtdHorasTrabalhoDia().ifPresent(qtdHorasTrablahodia -> funcionario.setQtdHorasTrabalhoDia(Float.valueOf(qtdHorasTrablahodia)));
	...
	/**
	 * Convert os dados de um funcionario em um DTO
	 * @param funcionario
